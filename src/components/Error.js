      ...
      <div className="px-3 py-3 mx-auto sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex items-center flex-1 w-0">
            <span className="flex p-2 bg-red-800 rounded-lg dark:bg-red-800">
              <svg
          ...
          <div className="flex-shrink-0 order-2 sm:order-3 sm:ml-3">
            <button
              ...
              className="flex p-2 -mr-1 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2"
            >
